...
export interface BadgeProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: 'default' | 'secondary' | 'destructive' | 'outline' | 'compliance-safe' | 'compliance-warning' | 'compliance-critical' | 'compliance-pending'
}
...
function Badge({ className, variant = 'default', ...props }: BadgeProps) {
  ...
  const variantClasses = {
    ...
    'compliance-warning': "compliance-warning",
